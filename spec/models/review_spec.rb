describe "A review" do
  ...
  it "requires a name" do
    ...
    expect(review.errors[:name].any?).to be true
  end
  ...
  it "requires a comment" do
    ...
    expect(review.valid?).to be false
    expect(review.errors[:comment].any?).to be true
  end
  ...
  it "accepts star values of 1 through 5" do
    ...
    stars.each do |star|
      ...
      expect(review.valid?).to be false
      expect(review.errors[:stars].any?).to be false
    end
  end
  ...
  it "rejects invalid star values" do
    ...
    stars.each do |star|
      ...
      expect(review.valid?).to be false
      expect(review.errors[:stars].any?).to be true
